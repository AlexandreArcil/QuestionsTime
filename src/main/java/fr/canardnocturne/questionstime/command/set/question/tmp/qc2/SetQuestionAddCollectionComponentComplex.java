...
public class SetQuestionAddCollectionComponentComplex<B, T, W, V extends Collection<W>> {

    private final QuestionModifierComplexAdd<B, T, W, V> questionModifier;
    protected final QuestionComponentComplexCollection<B, T, W, V> questionComponent;

    public SetQuestionAddCollectionComponentComplex(final QuestionModifierComplexAdd<B, T, W, V> questionModifier,
