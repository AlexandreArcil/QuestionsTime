...
import fr.canardnocturne.questionstime.command.set.question.tmp.qc.ListQuestionComponent;
...
public abstract class SetQuestionListComponentComplexExecutor<B, T, W, V extends Collection<W>> {

    protected final QuestionComponentComplexCollection<B, T, W, V> questionComponent;

    public SetQuestionListComponentComplexExecutor(final QuestionComponentComplexCollection<B, T, W, V> questionComponent) {
