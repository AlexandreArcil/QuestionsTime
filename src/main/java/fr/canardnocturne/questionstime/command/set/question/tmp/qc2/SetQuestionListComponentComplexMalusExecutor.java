...
public class SetQuestionListComponentComplexMalusExecutor<W, V extends Collection<W>> extends SetQuestionListComponentComplexExecutor<Malus.Builder, Malus, W, V> implements CommandExecutor {

    private final Parameter.Value<Question> specificQuestionParameter;

    public SetQuestionListComponentComplexMalusExecutor(final Parameter.Value<Question> specificQuestionParameter,
