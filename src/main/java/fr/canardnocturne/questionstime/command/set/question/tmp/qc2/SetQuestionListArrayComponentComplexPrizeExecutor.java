...
public class SetQuestionListArrayComponentComplexPrizeExecutor<V> extends SetQuestionListArrayComponentComplexExecutor<Prize.Builder, Prize, V> implements CommandExecutor {
    ...
    public SetQuestionListArrayComponentComplexPrizeExecutor(final Parameter.Value<Question> specificQuestionParameter,
                                                             final QuestionComponentComplexPrizeArray<V> questionComponent) {
