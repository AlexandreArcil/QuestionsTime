...
public class SetQuestionAddComponentComplexExecutor implements CommandExecutor {

    private final Parameter.Value<Question> specificQuestionParameter;
    private final QuestionModifierAddComplex questionModifier;
    private final ListQuestionComponent questionComponent;

    public SetQuestionAddComponentComplexExecutor(final Parameter.Value<Question> specificQuestionParameter,
                                                  final QuestionModifierAddComplex questionModifier,
