...
public class SetQuestionRemoveIncludePermissionsExecutor implements CommandExecutor  {
    ...
    public SetQuestionRemoveIncludePermissionsExecutor(final Parameter.Value<Question> specificQuestionParameter, final QuestionModifier questionModifier, final QuestionPool questionPool, final QuestionRegister questionRegister) {
    ...
    public CommandResult execute(final CommandContext context) throws CommandException {
        ...
        try {
            ...
            if(permissionsSeparated.length == 1) {
                context.sendMessage(TextUtils.composed("Include permission ", permissions, " removed !"));
            } else {
                context.sendMessage(TextUtils.composed("Include permissions ", String.join(", ", permissionsSeparated), " removed !"));
            }
