...
public class QuestionRemoveComponentParameter {
    ...
    public static <W, V extends Collection<W>> Parameter.Value<String> create(final Parameter.Value<Question> questionParam,
                                                 final QuestionComponentComplexCollection<Question.QuestionBuilder, Question, W, V> componentCollection) {
        return Parameter.builder(String.class)
                .addParser((parameterKey, reader, context) -> {
                    ...
                    final V values = componentCollection.getComponent.apply(question);
                ...
                .completer((context, input) ->
                        context.one(questionParam)
                                .map(question -> componentCollection.getComponent.apply(question).stream()
