...
public class QuestionModifierAddPositionComplex {

    private final QuestionModifierComplex questionModifier;

    public QuestionModifierAddPositionComplex(final QuestionModifierComplex questionModifier) {
        this.questionModifier = questionModifier;
    }

    Question add(final Question question, final ListQuestionComponent questionComponent, final int position,
                 final Collection<String> components) throws IOException {
