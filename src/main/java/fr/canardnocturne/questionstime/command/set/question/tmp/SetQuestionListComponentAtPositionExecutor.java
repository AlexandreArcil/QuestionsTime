...
public class SetQuestionListComponentAtPositionExecutor implements CommandExecutor {
    ...
    public SetQuestionListComponentAtPositionExecutor(final Parameter.Value<Question> specificQuestionParameter, final Parameter.Value<Integer> positionParameter,
    ...
    public CommandResult execute(final CommandContext context) throws CommandException {
        ...
        final Map<Integer, Collection<String>> componentValues = this.componentExtractor.apply(question);
