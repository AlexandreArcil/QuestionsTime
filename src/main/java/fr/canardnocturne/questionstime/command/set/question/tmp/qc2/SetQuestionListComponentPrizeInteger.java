...
public class SetQuestionListComponentPrizeInteger implements CommandExecutor {

    final Parameter.Value<Question> specificQuestionParameter;

    public SetQuestionListComponentPrizeInteger(final Parameter.Value<Question> specificQuestionParameter) {
